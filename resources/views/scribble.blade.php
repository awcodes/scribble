<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div
        ...
        @class([
            'notepad-wrapper relative z-0 rounded-md relative text-gray-950 bg-white shadow-sm ring-1 dark:bg-white/5 dark:text-white focus-within:ring focus-within:ring-primary-500 focus-within:z-10',
